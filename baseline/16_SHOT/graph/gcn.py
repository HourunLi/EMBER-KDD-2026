"""Pure-PyTorch sparse GCN modules used by the BailA SHOT experiment."""
...
class GCNEncoder(nn.Module):
    """Two-layer GCN replacing the image backbone in original SHOT."""
...
class FeatureBottleneck(nn.Module):
    """Linear + BatchNorm bottleneck matching the original SHOT design."""
...
class WeightNormalizedClassifier(nn.Module):
    """Frozen source hypothesis during target adaptation."""
