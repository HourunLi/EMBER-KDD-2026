...
OUTPUT_ROOT="${OUTPUT_ROOT:-${REPO_ROOT}/outputs/pokec_z_to_pokec_n_nrc_gcn}"
SOURCE_EPOCHS="${SOURCE_EPOCHS:-200}"
TARGET_EPOCHS="${TARGET_EPOCHS:-15}"
TARGET_BATCH_SIZE="${TARGET_BATCH_SIZE:-2048}"
MEMORY_BANK_SIZE="${MEMORY_BANK_SIZE:-0}"
NEIGHBOR_QUERY_CHUNK_SIZE="${NEIGHBOR_QUERY_CHUNK_SIZE:-64}"

SOURCE_CSV="${REPO_ROOT}/dataset/pokec_z/pokec_z.csv"
SOURCE_EDGES="${REPO_ROOT}/dataset/pokec_z/pokec_z_edges.txt"
TARGET_CSV="${REPO_ROOT}/dataset/pokec_n/pokec_n.csv"
TARGET_EDGES="${REPO_ROOT}/dataset/pokec_n/pokec_n_edges.txt"
...
for SEED in 1 2 3 4 5; do
  ...
  echo "============================================================"
  echo "Seed ${SEED}: stage 1/3 - supervised pokec_z training"
  echo "============================================================"
  ...
  echo "============================================================"
  echo "Seed ${SEED}: stage 2/3 - label-free pokec_n NRC adaptation"
  echo "============================================================"
  ...
  echo "============================================================"
  echo "Seed ${SEED}: stage 3/3 - final label/region evaluation"
  echo "============================================================"
...
echo "============================================================"
echo "All five Pokec seeds completed."
