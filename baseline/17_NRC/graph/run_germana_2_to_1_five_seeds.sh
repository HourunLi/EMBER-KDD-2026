...
OUTPUT_ROOT="${OUTPUT_ROOT:-${REPO_ROOT}/outputs/germanA_2_to_germanA_1_nrc_gcn}"
SOURCE_EPOCHS="${SOURCE_EPOCHS:-300}"
TARGET_EPOCHS="${TARGET_EPOCHS:-15}"
TARGET_BATCH_SIZE="${TARGET_BATCH_SIZE:-64}"

SOURCE_CSV="${REPO_ROOT}/dataset/germanA/germanA_2.csv"
SOURCE_EDGES="${REPO_ROOT}/dataset/germanA/germanA_2_edges.txt"
TARGET_CSV="${REPO_ROOT}/dataset/germanA/germanA_1.csv"
TARGET_EDGES="${REPO_ROOT}/dataset/germanA/germanA_1_edges.txt"
...
for SEED in 1 2 3 4 5; do
  ...
  echo "============================================================"
  echo "Seed ${SEED}: stage 1/3 - supervised GermanA_2 training"
  echo "============================================================"
  ...
  echo "============================================================"
  echo "Seed ${SEED}: stage 2/3 - label-free GermanA_1 NRC adaptation"
  echo "============================================================"
  ...
  echo "============================================================"
  echo "Seed ${SEED}: stage 3/3 - final GoodCustomer/Gender evaluation"
  echo "============================================================"
...
echo "============================================================"
echo "All five GermanA seeds completed."
