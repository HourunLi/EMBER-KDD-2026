from .basic_blocks import Extractor, Classifier, CrossEntropy
...
class Model(nn.Module):
    ...
    def train_target(self, target_data, target_structure_data, structure_adj, criterion, optimizer, epoch):
        ...
        if epoch == 0:
            source_target_acc = evaluate(outputs, target_data.y, self.args.metric)
        ...
        return evaluate(outputs, target_data.y, self.args.metric)
