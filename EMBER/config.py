...
# parser.add_argument('--inid',    type=str, default='_1')
# parser.add_argument('--outid',   type=str, default='_2')
...
require(args.adapt_epochs >= 100, "adapt_epochs must be at least 100")
...
require(0.1 <= args.lambda_pi <= 1.0, "lambda_pi (eta) must lie in [0.1, 1]")
